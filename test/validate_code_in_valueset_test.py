"""Integration tests: MCP `validate_code_in_valueset` against `validate_code_in_valueset_ground_truth.json`."""
...
GROUND_TRUTH_PATH = (
    ...
    / "ground_truth"
    / "validate_code_in_valueset_ground_truth.json"
)
...
def _case_id(case: dict[str, Any]) -> str:
    ...
    return f"{inp.get('valueset_url', '')}|{inp.get('code', '')!r}"
...
async def test_validate_code_in_valueset_matches_ground_truth(case: dict[str, Any]) -> None:
